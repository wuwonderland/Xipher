export const surpriseMePrompts = [
  ...
  "A Samurai holding a sword with Cyberpunk vibe, digital art",
  "back to the future, digital art",
  "DC comic Batman fighting with James Dean in the Forbidden City, digital art",
  "Rick and Morty back to the future captured by Sony α7 IV, ultra high definition 8k, digital art",
  "A baby in cyberpunk 2077 captured by Nikon D850, front shot with shallow depth of field --ar2:3",
];
